...
@WebServlet(name="ParanormalHomeServlet", urlPatterns={"/ParanormalHomeServlet"})
public class ParanormalHousesServlet extends HttpServlet {
    ...
    */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)//request-information coming from browser, response- information send back
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String XMLFileName = path + "/HauntedHouse.xml";//xml
            String XSLFileName = path + "/HauntedHouse.xsl";//xsl
