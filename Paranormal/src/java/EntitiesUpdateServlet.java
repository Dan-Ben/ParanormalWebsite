 ...
 * x13341086
 */
@WebServlet(name="EntitiesUpdateServlet", urlPatterns={"/EntitesUpdateServlet"})
public class EntitiesUpdateServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        //XML FILE IS RETRIEVED FROM EXIST, ONLY LINK XSL FILE HERE
        String path = getServletContext().getRealPath("/WEB-INF/");
        String XSLFileName = path + "/EntitiesUpdate.xsl";
        ...
        try {
            ...
            // get the collection
            Collection col = DatabaseManager.getCollection(URI + "/db/Paranormal", "admin", "password");
